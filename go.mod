module github.com/metskem/panzer-plugin
...
require (
	code.cloudfoundry.org/bytefmt v0.74.0 // indirect
	code.cloudfoundry.org/cli-plugin-repo v0.0.0-20260327014959-8574acfb0dc1 // indirect
	...
	github.com/cloudfoundry/bosh-utils v0.0.613 // indirect
